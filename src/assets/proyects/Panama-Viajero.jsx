    ...
    return (
        <div className="rounded-2xl max-w-md bg-gradient-to-r from-[#060D17] to-[#4956A2]">
            <div className="p-3 rounded-t-xl hover:scale-103 transition-all duration-300">
                <a href="https://panama-viajero.pages.dev" target="_blank" className="flex items-center justify-center gap-2 cursor-pointer">
                    {/* LOGO */}
            ...
            <div className="bg-[#060D17] py-2 rounded-b-xl px-3">
                ...
                <a href="https://panama-viajero.pages.dev" target="_blank" className="flex gap-2 font-inter text-sm items-center mt-2 cursor-pointer hover:bg-[#0465F1]/15 
